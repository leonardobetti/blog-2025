    ...
    <footer>
      <div className="mx-auto mt-12 max-w-screen-xl">
        <div className="flex flex-col-reverse items-center justify-between gap-x-2 gap-y-5 px-6 py-8 sm:flex-row xl:px-0">
          {/* Copyright */}
          <span className="text-balance text-center text-sm text-muted-foreground sm:text-left">
          ...
          <div className="flex items-center gap-4 text-muted-foreground">
            ...
            <Link href="https://github.com/leonardobetti" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
